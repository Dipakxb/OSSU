...
(check-expect (has-landed? RD1) false)
(check-expect (has-landed? RD2) false)
(check-expect (has-landed? RD3) false)
(check-expect (has-landed? RD4) true)

;(define (has-landed? r) r) ; stub

; template used form data definition

; modified to make it concise
